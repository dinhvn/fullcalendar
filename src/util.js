...
function colorDown(color, downRate) {
	if(color === undefined) { return; }
	downRate = downRate || 0.92;
	color = color.replace("#", "");
	var list = color.match(/[a-fA-F0-9]{2}/g);
	var result = ("0" + parseInt((parseInt(list[0], 16) * downRate), 0).toString(16)).slice(-2) +
					("0" + parseInt((parseInt(list[1], 16) * downRate), 0).toString(16)).slice(-2) +
					("0" + parseInt((parseInt(list[2], 16) * downRate), 0).toString(16)).slice(-2);
	return "#" + result;
}